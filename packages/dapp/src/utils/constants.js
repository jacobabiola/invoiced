...
export const graphUrls = {
  ...
  83: `http://graph-on-testnet.meter.io:8000/subgraphs/name/${NETWORK_CONFIG[83].SUBGRAPH}`,
};
...
export const tokens = {
  ...
  83: Object.keys(NETWORK_CONFIG[83].TOKENS),
};
...
export const resolvers = {
  ...
  83: Object.keys(NETWORK_CONFIG[83].RESOLVERS),
};
...
export const resolverInfo = {
  ...
  83: NETWORK_CONFIG[83].RESOLVERS,
};
...
export const wrappedNativeToken = {
  ...
  83: NETWORK_CONFIG[83].WRAPPED_NATIVE_TOKEN,
};
...
export const invoiceFactory = {
  ...
  83: NETWORK_CONFIG[83].INVOICE_FACTORY,
};
